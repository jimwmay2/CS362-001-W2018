...
public class CalDayTest {
	...
	public void test() {
		...
		assertEquals("Birthday Party 4",(calday1.getAppts().get(3)).getTitle());
		//test get methods
	...
	public void test1() {
    	...
    	Calendar rightnow = Calendar.getInstance();
		 ...
		 GregorianCalendar today = new GregorianCalendar(rightnow.get(Calendar.YEAR),13,rightnow.get(Calendar.DAY_OF_MONTH));
		 CalDay calday1 = new CalDay(today);
		 
		 Iterator<Appt> itr = calday1.getAppts().iterator();
		 //assertFalse(itr.hasNext());
		 if(calday1.iterator() == null) {
			 fail();
		 }
